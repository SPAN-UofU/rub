...
#
# 2. Load file, put RSS meas'ts per link into matrix.
#
filename_with_path = dirname + filename
print "Loading file: " + filename_with_path
data         = np.loadtxt(filename_with_path)

#
# 2.1 Skip first few and last few rows if needed.
#
