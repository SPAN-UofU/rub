...
class Metronome():
    ...
    sound_high = None
    sound_low = None
    report = "BPM: %s - Metrum %s/%s - Accent: %s - Repeats: %s - Time: %s"
    ...
    def main(self):
        ...
        try:
            if self.timestamp:
                ...
                timeSecStr = 'Start time: {:.5f}'.format(timeStampSec)
                sys.stdout.write(timeSecStr + '\n')
                sys.stdout.flush()
    ...
    def play_file(self, filename):
        ...
        try:
            ...
            if self.timestamp:
                timeStampSec = time.time()
                timeSecStr = 'Stop time: {:.5f}'.format(timeStampSec)
                sys.stdout.write(timeSecStr + '\n')
                sys.stdout.flush()
...
def usage():
    ...
    print("-x, --timestamp - makes program report timestamp")
...
if __name__ == "__main__":
    ...
    from_file = False
    try:
        opts, args = getopt.getopt(sys.argv[1:], "hf:b:t:n:avx", ["help", "file=","bpm=","ticks=","note=","accent","verbose", "timestamp"])
    ...
    for o, a in opts:
        ...
        elif o in ("-x", "--timestamp"):
            metronome.timestamp = True
        else:
