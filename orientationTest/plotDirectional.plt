...
filename = "breathing_rf_chest_up"
set output "Directional.eps"

set multiplot layout 2, 1 title "Directional"
...
unset key
set ylabel "BPM"
plot "output_directional.txt" using ($1-start):2 title 'BPM' with lines ls 1 lc 5 lw 1 
